...
module.exports.changeStatus = function changeStatus( res, body, userID, proposalID) {
...
module.exports.getHandsOnEngineerProposal = function getHandsOnEngineerProposal ( res,  userID, proposalID) {
